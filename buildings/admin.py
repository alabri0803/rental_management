...
class UnitAdmin(ImportExportModelAdmin):
    list_display = ('unit_number', 'unit_type', 'floor', 'area', 'is_available', 'monthly_rent')
...
# تسجيل النماذج في custom_admin_site
custom_admin_site.register(Governorate, GovernorateAdmin)
custom_admin_site.register(Wilayat, WilayatAdmin)
custom_admin_site.register(Building, BuildingAdmin)
custom_admin_site.register(Floor, FloorAdmin)
