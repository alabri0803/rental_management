...
class Contract(models.Model):
  lessor_name = models.CharField(
    max_length=255, 
    verbose_name=_('اسم المؤجر')
  )
  lessor_type = models.CharField(
    max_length=3, 
    choices=LessorType.choices, 
    verbose_name=_('نوع المؤجر')
  )
  lessor_relation = models.CharField(
    max_length=3, 
    choices=LessorRelation.choices, 
    verbose_name=_('علاقة المؤجر')
  )

  is_lessor_owner_of_building = models.BooleanField(
    verbose_name=_('هل المؤجر هو مالك المبنى؟')
  )
  ...
  purpose_of_contract = models.CharField(
    max_length=10, 
    choices=PuropseOfContract.choices, 
    verbose_name=_('الغرض من العقد')
  )
  residential_usage = models.CharField(
    max_length=4, 
    choices=ResidentialUsageType.choices, 
    verbose_name=_('نوع السكن')
  )
  land_usage_puropose = models.CharField(
    max_length=4, 
    choices=LandUsagePurpose.choices, 
    verbose_name=_('الغرض من استعمال الأرض')
  )

  rent_amount = models.DecimalField(
    max_digits=12, 
    decimal_places=3, 
    verbose_name=_('قيمة الإيجار')
  )
